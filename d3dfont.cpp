...
#include "D3DFont.h"
#include "Direct3D.h"
//#include "D:\새이름 프로그램\워리어\COMMON\INCLUDE\D3DUtil.h"
//#include "D:\새이름 프로그램\워리어\COMMON\INCLUDE\DXUtil.h"
...
{
    SAFE_RELEASE_( m_pVB );
    SAFE_RELEASE_( m_pStateBlockSaved );
    SAFE_RELEASE_( m_pStateBlockDrawText );
